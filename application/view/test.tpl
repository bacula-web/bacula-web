...
<div class="container" id="testpage">
	...
	<div class="row">
		<div class="col-xs-6"> <img class="img-responsive center-block" src="{$bar_graph}" alt="Graph 1"> </div>
		<div class="col-xs-6"> <img class="img-responsive center-block" src="{$pie_graph}" alt="Graph 2"> </div>
	</div>
