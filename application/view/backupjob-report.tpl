...
<div class="container">
   ...
   <h4>{t}Transfered Bytes / Files{/t}</h4>
	...
	<div class="row">
		<div class="col-xs-6"> <img class="img-responsive center-block" src="{$graph_stored_bytes}" alt="Stored Bytes"> </div>
		<div class="col-xs-6"> <img class="img-responsive center-block" src="{$graph_stored_files}" alt="Stored Files"> </div>
	</div> <! -- div class="row" -->
