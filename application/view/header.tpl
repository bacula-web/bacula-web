...
<head>
  ...
  <link rel="stylesheet" href="core/vendor/bootstrap-3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="core/vendor/bootstrap-3.3.4/css/bootstrap-theme.min.css"> 
