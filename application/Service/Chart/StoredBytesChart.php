 ...
 */
class StoredBytesChart extends BarChart
{
     ...
     * @param string|null $backupJobName
     * @return Chart
     * @throws NoResultException
     * @throws NonUniqueResultException
     */
    public function getChart(Carbon $from, Carbon $to, int $clientId = null, string $backupJobName = null): Chart
    {
