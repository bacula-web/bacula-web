...
{block name=body}
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="mt-3 mb-0">{t}Settings{/t}</h3>
                <p class="mb-0">{t}General settings{/t}</p>
                <hr>
            </div>
        </div>
                    ...
                    <div class="tab-pane active" id="general"><h4>General settings</h4>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label" for="config_datetime_format">Date / Time
                                    format</label>
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" id="config_datetime_format"
                                           value="{$config_datetime_format}" readonly>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" id="config_language"
                                           value="{$config_language}" readonly>
                                </div>
                            </div> <!-- end div class=form-group -->

                            <!-- Show inactive clients -->
                            <div class="form-group">
                                <label class="col-xs-4 control-label" for="config_show_inactive_clients">Show inactive
                                    clients</label>
                                <div class="col-xs-8">
                                    <input type="checkbox"
                                           id="config_show_inactive_clients" {$config_show_inactive_clients} disabled>
                                </div>
                            </div> <!-- end div class=form-group -->

                            <!-- Hide empty pools -->
                            <div class="form-group">
                                <label class="col-xs-4 control-label" for="config_hide_empty_pools">Hide empty
                                    pools</label>
                                <div class="col-xs-8">
                                    <input type="checkbox" id="config_hide_empty_pools" {$config_hide_empty_pools}
                                           disabled>
                                </div>
                            </div> <!-- end div class=form-group -->
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label" for="config_enable_users_auth">Users
                                    authentication</label>
                                <div class="col-xs-8">
                                    <input type="checkbox" id="config_eanble_users_auth" {$config_enable_users_auth}
                                           disabled>
                                </div>
                            </div> <!-- end div class=form-group -->
