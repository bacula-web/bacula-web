                ...
                <div class="tab-content">
                    <div class="tab-pane container active" id="general"><h4>General settings</h4>
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="config_show_inactive_clients">Show inactive clients</label>

                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="config_show_inactive_clients" {$config_show_inactive_clients} disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="config_hide_empty_pools" {$config_hide_empty_pools} disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="config_enable_users_auth" {$config_enable_users_auth} disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="config_debug" {$config_debug} disabled>
