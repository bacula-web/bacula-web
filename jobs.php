...
try {
  ...
  $view->assign( 'job_status_filter', $job_status_filter);
  $view->assign( 'job_level_filter', $job_level_filter);
  $view->assign( 'job_poolid_filter', $job_poolid_filter);
  $view->assign( 'job_clientid_filter', $job_clientid_filter);
  $view->assign( 'job_starttime_filter', $job_starttime_filter);
  $view->assign( 'job_endtime_filter', $job_endtime_filter);
  ...
  $view->assign('result_order_field', $job_orderby_filter);

  if($job_orderby_asc_filter == 'ASC') {
     $view->assign('result_order_asc_checked', 'checked');
  }
