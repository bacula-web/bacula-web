...
If you have used the `docker-compose.yml` with `docker compose`, you can check the container logs.
...
[Bacula-Web on DockerHub](https://hub.docker.com/r/baculaweb/bacula-web)
