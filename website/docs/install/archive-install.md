...
```shell
$ curl -O -L https://github.com/bacula-web/bacula-web/releases/download/v9.9.0/bacula-web-v10.0.0.tgz
```
...
```shell
curl -LO https://github.com/bacula-web/bacula-web/releases/download/v10.0.0/bacula-web-sha256.txt 
```

For the SHA-512 signature file
```shell
curl -LO https://github.com/bacula-web/bacula-web/releases/download/v10.0.0/bacula-web-sha512.txt 
```
...
```shell
bacula-web-v10.0.0.tgz: OK
```

## Decompress the archive

```shell
$ tar -xvf bacula-web-v10.0.0.tgz
```

::::tip[Using different version ?]
The above instructions use version **10.0.0** as an example; you must replace it with the version you are using.
::::
